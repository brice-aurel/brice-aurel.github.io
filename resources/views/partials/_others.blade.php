...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-12 col-md-4">
            ...
            <p class="text-justify text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur commodi
                doloribus quibusdam nam hic repellat distinctio. Perspiciatis, dolor. Laboriosam, quam!</p>
        </div>
        <div class="col-12 col-md-4">
            ...
            <p class="text-justify text-muted">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nisi animi
                numquam praesentium ipsa, iure repudiandae dolor ipsam, recusandae est perspiciatis.</p>
        </div>
        <div class="col-12 col-md-4">
            <div class="mb-3 text-center"><i class="fas fa-download"></i></div>
            <h1 class="h5 text-center"><b>GET INSTAND DOWNLOAD</b></h1>
            <p class="text-center text-muted">Lorem ipsum, dolor sit, amet consectetur adipisicing elit. Laudantium
                assumenda magnam neque explicabo! Dolores saepe assumenda at omnis, quo, reprehenderit.</p>
        </div>
        ...
        <div class="col-12 col-md-6 offset-md-6 mt-5">
            <a href="{{ route('product.index') }}" class="btn btn-info btn-lg"><b>Browse All Products</b> <i
        ...
        <div class="ol-12 col-md-4 px-4 py-1 mt-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted text-justify">Lorem ipsum dolor sit amet consectetur adipisicing, elit. Nulla
                        earum sed nam, atque veniam pariatur quas, nihil consequatur animi? Voluptas excepturi
                        repellendus quos cupiditate nihil?</p>
